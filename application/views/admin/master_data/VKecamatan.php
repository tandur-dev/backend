    ...
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            <div class="card-header">
                ...
                <a href="<?= base_url('ProvinsiController/tambahProvinsi/'); ?>" class='btn btn-primary btn-sm' type='submit'><i class="fa fa-plus mr-1"></i>Tambah Kecamatan</a>
            </div>
            <div class="card-body">
                <div class="datatable">
                    <?php
                    $template = array('table_open' => '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">');
                        ...
                        $this->table->set_heading('ID Kecamatan', 'ID Kota', 'Nama Kota','Aksi');
                        $no = 1;
                        ...
                        $row->NAMA_KECAMATAN,
                        '
                        <a title="Edit Kamar" href="'.  base_url("ProvinsiController/editProvinsi/".$row->ID_KECAMATAN).'" type="button" class="btn btn-warning mt-1 btn-sm"><i class="fa fa-edit"></i>
                        </a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <h5>Apakah anda yakin akan menghapus kamar <b> <?= $row->NAMA_KOTA ?> ? </b></h5>
                            </div>
                            <div class="modal-footer">
                                <a href="<?= base_url('Kamar/aksiHapusKamar/'.$row->ID_KOTA) ?>" type="button" class="btn btn-danger"><i class="fa fa-trash mr-1"></i>Hapus</a>
