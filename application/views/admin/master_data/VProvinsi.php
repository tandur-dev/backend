                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <h5>Apakah anda yakin akan menghapus kamar <b> <?= $row->NAMA_PROVINSI ?> ? </b></h5>
                            </div>
                            <div class="modal-footer">
                                <a href="<?= base_url('Kamar/aksiHapusKamar/'.$row->ID_PROVINSI) ?>" type="button" class="btn btn-danger"><i class="fa fa-trash mr-1"></i>Hapus</a>
