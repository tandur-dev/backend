            ...
            <div class="card-body">
                <div class="datatable">
                    ...
                    $template = array('table_open' => '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">');
                        ...
                        $this->table->set_heading('ID Kota', 'ID Provinsi', 'Nama Kota','Aksi');
                        $no = 1;
                        foreach ($kota as $row) {
                        $this->table->add_row(
                        $row->ID_KOTA,
                        ...
                        $row->NAMA_KOTA,
                        '
                        <a title="Edit Kamar" href="'.  base_url("ProvinsiController/editProvinsi/".$row->ID_KOTA).'" type="button" class="btn btn-warning mt-1 btn-sm"><i class="fa fa-edit"></i>
                        </a>
