...
<body>
    ...
    <div class="container-fluid mt-n10">
        <div class="row">
            <div class="col-xxl-14 col-xl-12 mb-4">
                ...
                <div class="card bg-green text-white mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mr-3">
                                <div class="text-white-75 small">Jumlah Customer</div>
                                <div class="text-lg font-weight-bold">12 Customer</div>
                            </div>
            ...
            <div class="col-xxl-4 col-lg-4">
                <div class="card bg-yellow text-white mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mr-3">
                                <div class="text-white-75 small">Reservasi</div>
                                <div class="text-lg font-weight-bold">11 Reservasi</div>
                            </div>
            ...
            <div class="col-xxl-4 col-lg-4">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mr-3">
                                <div class="text-white-75 small">Jumlah Checkout</div>
                                <div class="text-lg font-weight-bold">10 Checkout</div>
                            </div>
